# Copied from Todos imports + router = APIRouter() + get_db + both dependency
...
# iSme tumko admin id se login and you will be able to see todos of all users at a time
